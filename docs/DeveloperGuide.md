...
public class MainWindow extends UiPart<Stage>
    ...
    public MainWindow(Logic logic) {
        commandBox = new CommandBox(this); // 'this' (MainWindow) implements CommandExecutor
        filterPanel = new FilterPanel(logic.getFilterDetails(), this); // 'this' (MainWindow) implements FilterExecutor
    }
}
```
